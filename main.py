...
До речі, зробили скрипт для автоматичного кидання репортів. Тепер можна не тицяти руцями, але є невелика ймовірність що вас тимчасово забанять. Якщо цікаво пропиши /script\n\n\
